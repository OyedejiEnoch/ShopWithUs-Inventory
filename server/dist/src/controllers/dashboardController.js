...
const getDashboardMetrics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCategory = expenseByCategoryRaw.map((item) => (Object.assign(Object.assign({}, item), { amount: item.amount.toString })));
        res.status(200).json({
            popularProducts,
            salesSummary,
            expenseByCategory,
        ...
        res.status(500).json({
            message: 'Error retriving dashboard metrics'
        });
    }
});
